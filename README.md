# Obsidian Live Preview Options

This is an [Obsidian.md](https://obsidian.md) plugin, which allows you to **partially** turn off Live Preview.
...
3. Open the following URL in the browser: `obsidian://brat?plugin=RyotaUshio/obsidian-live-preview-options`.
